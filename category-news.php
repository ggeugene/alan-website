...
<main id="content" class="site-content">
	<div id="primary" class="content-area">
		...
		<div class="container">
			...
			<div class="col-sm-12">
				<div class="row">
					<?php echo '<h2 class="blog-page-title">' . __('News', 'workrocks') . '</h2>'; ?>
							...
							<div class="post-item clearfix">
								...
								<div class="col-sm-6">
									<div class="post-item-content">
										...
										<div class="post-item-link custom-text-icon"><a href="<?php the_permalink(); ?>"><?php echo __('Детальніше','workrocks'); ?></a></div>
									</div>
